...
namespace QlyNhaHang.Admin.Controllers
{
    public class ProductsController : Controller
    {
        private DienThoaiEntities2 db = new DienThoaiEntities2();
        ...
        public ActionResult ProductList(int? category, string SearchString, double min = double.MinValue, double max = double.MaxValue)
        {
            ...
            {
                products = db.Product.Where(s => s.NamePro.Contains(SearchString.Trim()));
            }
